...
const words = {
  en: {
    term: "Free payment",
    termKey: "free payment",
    plural: "free payments",
    alias: "Free contribution",
    aliasKey: "free contribution",
    short: "FP",
    shortKey: "fp",
    object: "Payment",
    objectKey: "payment",
  ...
  fr: {
    term: "Versement libre",
    termKey: "versement libre",
    plural: "versements libres",
    alias: "Prélèvement libre",
    aliasKey: "prelevement libre",
    short: "VL",
    shortKey: "vl",
    object: "Versement",
    objectKey: "versement",
