...
describe("ApiPage", () => {
  ...
  it("imposes the page order: the tree, the breadcrumb, the title, the line naming the type, the change and the space without any highlight, the note, the operations, the contract, the legend and the path, then the panel", () => {
    ...
    expectInOrder(html, [
      ...
      '<footer class="entity-footer"><p class="legend"><span class="legend-written">written link</span><span class="legend-recognised">recognised word, existing note</span><span class="legend-keyword">recognised word, no note</span></p><p class="entity-source"><code><span class="entity-source-folders">specs/api/</span>model-query.md</code>',
