...
An unclassified note lies within the radius of a pivot of the neighbourhood: a candidate for the pivot's own domain when something files the pivot, else for a domain named after it.
